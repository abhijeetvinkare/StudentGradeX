...
import "../../Admin/Pages/AdminChangePassword/ChangePass.css";
...
function TeacherChangePass() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(
        "http://localhost:5000/teacher/api/change-teacher-pass",
      ...
      .then((res) => {
        if (res.data === "Old password is incorrect") {
          ...
          Swal.fire({
            ...
            icon: 'error',
            title: 'Oops...',
            text: 'You are using a public admin ID for demonstration purposes. For security reasons, password changes are not allowed for this user.',
          })
          setOldPass("");
          setNewpass("");
          setRe_typePass("");
